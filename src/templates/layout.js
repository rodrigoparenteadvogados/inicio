// Template de Layout Principal do Website
const { renderBreadcrumbs, renderDropdownItems } = require('./components');

module.exports = function renderLayout(page, content, areas) {
  const dropdownHTML = renderDropdownItems(areas);
  const breadcrumbsHTML = renderBreadcrumbs(page.breadcrumbs);
  
  // Script Schema.org para SEO Local (LocalBusiness / LegalService)
  const schemaMarkup = {
...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Playfair+Display:ital,wght@0,400;0,600;0,700;1,400&display=swap" media="print" onload="this.media='all'">
  <noscript>
  ...
  <!-- Favicon fictício ou placeholder -->
