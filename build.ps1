...
function Render-TeamCards($limit = $null) {
  $team = @(
    @{ name = "Dr. Rodrigo Parente"; role = "Advogado e Proprietário"; oab = "OAB/CE 38.940" },
    @{ name = "Dra. Laura Grangeiro"; role = "Advogada Associada"; oab = "OAB/CE 32.465" },
    @{ name = "Dra. Eveli Rodrigues"; role = "Advogada Associada"; oab = "OAB/CE 54.390" },
    @{ name = "Dr. Johnathan Marques"; role = "Bacharel & Economista (UFC)"; oab = "Graduando em Direito / Economista" },
