        ...
        <section class="hero">
          <div class="container hero-grid">
            <div class="hero-content">
              ...
              <h1>Escritório de Advocacia<br>Dr Rodrigo Parente<br><span style="white-space: nowrap;">Advogados Especializados</span></h1>
            ...
            <div class="hero-image-wrap">
              <img src="img/hero-side.webp" alt="Balança da Justiça - Rodrigo Parente Advogados" class="hero-side-img" width="1024" height="1024">
            </div>
          </div>
        </section>
